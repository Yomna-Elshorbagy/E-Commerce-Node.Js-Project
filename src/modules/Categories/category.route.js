...
categoryRoutes.post("/category", addimg, validation(addCategrySchema), addcategory);
...
categoryRoutes.patch("/category/:categoryId",validation(updateCategrySchema),adminAuth, updateCategory) //who created the category
